...
- Name: Login.spec.js >> Login >>  TC02 - login for invalid roles invalid-email
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e12]:
        - link "Features" [ref=e13] [cursor=pointer]:
          - /url: "#features"
        - link "Launch Portal" [active] [ref=e14] [cursor=pointer]:
          - /url: /login
  - main [ref=e15]:
    - generic [ref=e18]:
      - generic [ref=e19]:
        ...
        - generic [ref=e26]:
          - link "Start Your Journey" [ref=e27] [cursor=pointer]:
            - /url: /login
